...
This repository demonstrates **Phase 1** of the **Banking Project 2026**, where the complete cloud infrastructure is provisioned using **Terraform** on **Google Cloud Platform (GCP)**.
...
Provision the complete infrastructure required for the Banking Project.
...
| VM Name | Purpose |
|----------|----------|
| bankingproject2026-jenkins-vm | Jenkins CI/CD Server |
| bankingproject2026-sonarqube-vm | SonarQube Code Quality |
| bankingproject2026-docker-vm | Docker Image Build Server |
| bankingproject2026-monitoring-vm | Prometheus & Grafana |
...
```bash
cd bankingproject2026-terraform
```
